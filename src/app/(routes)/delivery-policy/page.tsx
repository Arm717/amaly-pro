        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-[97px] px-[20px] mb-[40px] lg:mt-[155px] lg:mb-[92px] ">
          <div className="border-2 border-[var(--yellow)] p-6">
            ...
            <div className="px-[24px] pb-[24px]">
              <Text
                className="font-firaGo font-medium text-base"
              ...
              <Text
                className="font-firaGo font-medium text-base"
                value={`Доставка 500 рублей. Бесплатная доставка при заказе от 5000 рублей
              ...
              <Text
                className="font-firaGo font-medium text-base"
                value={`Самовывоз от любой суммы по адресу г. Москва, Митинская ул. 24Ас1`}
              />
