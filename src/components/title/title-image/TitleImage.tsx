...
const cloudImageVariant = {
  oneCloud: {
    ...
    textSize: "z-50 text-xl md:text-2xl lg:text-3xl font-semibold",
    alt: "cloud image",
  },
  twoCloud: {
    src: "/twoCloud.png",
    ...
    textSize: "text-lg md:text-xl lg:text-2xl font-semibold",
    alt: "two cloud image",
  },
  categoryCloud: {
    ...
    textSize: "text-sm xsm:text-sm  lg:text-2xl font-semibold",
